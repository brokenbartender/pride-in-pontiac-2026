    ...
    <div className="bg-pride-cream text-pride-ink min-h-screen py-24 px-6">
      <div className="max-w-4xl mx-auto border border-pride-black/10 bg-pride-white p-10 md:p-16 shadow-xl relative overflow-hidden">
        ...
        <div className="border-t border-pride-black/10 pt-10">
          <h3 className="font-serif font-bold text-2xl mb-6">Sign Up to Volunteer</h3>
          <iframe
            src="https://tally.so/embed/Gx4bLO?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
            loading="lazy"
            width="100%"
            height="900"
            frameBorder="0"
            title="Pride in Pontiac Volunteer Sign-Up"
            className="w-full"
          />
        </div>
      </div>
